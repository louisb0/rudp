...
[[nodiscard]] ssize_t send(int sockfd, const void *buf, size_t len, int flags) noexcept;
[[nodiscard]] ssize_t recv(int sockfd, void *buf, size_t len, int flags) noexcept;
